...
public class JFrameRetiroDeposito extends javax.swing.JFrame {
    ...
    public JFrameRetiroDeposito(Usuario u, SolicitudesServidor o) {
        initComponents();
             ...
             try {
                  jLabel2.setText(o.retirarDinero(Float.parseFloat(jTextField1.getText()), u));
         ...
         this.jButton2.addActionListener(new ActionListener() {
             public void actionPerformed(ActionEvent e) {
             try {
                  jLabel2.setText(o.depositarDinero(Float.parseFloat(jTextField1.getText()), u));
              } catch (RemoteException ex) {
                  Logger.getLogger(JFrameRetiroDeposito.class.getName()).log(Level.SEVERE, null, ex);
              }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 340, 200, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 140, 120, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Cliente/FONDO.jpg"))); // NOI18N
