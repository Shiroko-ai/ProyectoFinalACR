...
public class ObjetoRemoto extends UnicastRemoteObject implements SolicitudesServidor{
    ...
    public String retirarDinero(float cantidad, Usuario u) throws RemoteException{
        String retiro = null;
        try{
          BufferedReader bfd = new BufferedReader(new FileReader("C:/Users/LAST_/Downloads/dinero.txt"));
        if(u.dinero>cantidad){
             BufferedWriter writer = new BufferedWriter(new FileWriter("C:/Users/LAST_/Downloads/dinero.txt"));
